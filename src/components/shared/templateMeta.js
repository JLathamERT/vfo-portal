...
export const TEMPLATE_META = {
  ...
  'TAX': [
    ...
    ['TAX_presentation_link', 'Sends the member the tax presentation link ahead of the TPOM', 'To: Member · Auto-Cc: PF'],
    ...
    ['TAX_decision_rapid', 'Rapid Route email — customized video, agreement PDF, Yes / I have questions / No buttons', 'To: Client · Auto-Cc: Member + PF'],
    ['TAX_decision_rapid (member signing/paying on clients behalf)', 'Rapid Route email (member signing/paying on the client\'s behalf)', 'To: Member · Auto-Cc: Client + PF'],
    ['TAX_rapid_question_reply', 'Rapid Route — your reply to the client\'s question, with the Yes / I have questions / No buttons again', 'To: Client · Auto-Cc: Member + PF'],
    ['TAX_rapid_question_reply (member signing/paying on clients behalf)', 'Rapid Route question reply (member signing/paying on the client\'s behalf)', 'To: Member · Auto-Cc: Client + PF'],
    ['TAX_decision_reminder|rapid', 'Rapid Route — automatic reminder when the client has not answered (2 business days; paused while a question is open)', 'To: Client · Auto-Cc: Member + PF'],
    ['TAX_decision_reminder|rapid (member signing/paying on clients behalf)', 'Rapid Route reminder (member signing/paying on the client\'s behalf)', 'To: Member · Auto-Cc: Client + PF'],
    ['TAX_readyfortax3|Rapid','Rapid Route confirmed — approved, initial calculations being finalized, a customized video will follow', 'To: Client · Auto-Cc: Member + PF'],
